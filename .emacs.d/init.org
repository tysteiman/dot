...
This also takes a prefix to work easily with Docker containers by prefixing it with "docker-compose exec app <command>"

#+begin_src elisp

(defun my/async-shell-command-on-file (command &optional prefix-command)
  "Send current file as the argument to `command' i.e. <`command'> <current-file>"
  (interactive "sAsync shell command on file: ")
  (let* ((file (expand-file-name (buffer-file-name)))
         (command-to-run (concat prefix-command " " command " " file)))
